    ...
    <tbody>
      ...
      ?>
        <tr>
          ...
          <td><a href="index.php?uc=gererFrais&action=supprimerFrais&idFrais=<?php echo $id ?>" onclick="return confirm('Voulez-vous vraiment supprimer ce frais?');"><button type="button" class="btn btn-primary">Supprimer ce frais</button> </a></td>
        </tr>
      <?php
